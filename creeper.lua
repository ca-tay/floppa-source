...
RS.C1 = CF(0,1,0)*ANGLES(RAD(0),RAD(0),RAD(0))
LS.C1 = CF(0,1,0)*ANGLES(RAD(0),RAD(0),RAD(0))
...
RJ.C0 = RJ.C0:Lerp(CF(0+0*math.cos(sine/13),0+0.2*math.cos(sine/13),0+0.4*math.sin(sine/13))*ANGLES(RAD(0+0*math.sin(sine/13)),RAD(0+0*math.cos(sine/13)),RAD(0+0*math.cos(sine/13))),.3)
RS.C0 = RS.C0:Lerp(CF(0.5+0*math.cos(sine/13),-1+-0.2*math.cos(sine/13),0.8+0*math.cos(sine/13))*ANGLES(RAD(5+10*math.sin(sine/13)),RAD(20+0*math.cos(sine/13)),RAD(0+0*math.cos(sine/13))),.3)
LS.C0 = LS.C0:Lerp(CF(-0.5+0*math.cos(sine/13),-1+-0.2*math.cos(sine/13),0.8+0*math.cos(sine/13))*ANGLES(RAD(5+10*math.sin(sine/13)),RAD(-20+0*math.cos(sine/13)),RAD(0+0*math.cos(sine/13))),.3)
RH.C0 = RH.C0:Lerp(CF(0.5+0*math.cos(sine/13),-1+-0.2*math.cos(sine/13),-0.8+0*math.cos(sine/13))*ANGLES(RAD(-10+10*math.sin(sine/13)),RAD(-20+0*math.cos(sine/13)),RAD(0+0*math.cos(sine/13))),.3)
LH.C0 = LH.C0:Lerp(CF(-0.5+0*math.cos(sine/13),-1+-0.2*math.cos(sine/13),-0.8+0*math.cos(sine/13))*ANGLES(RAD(-10+10*math.sin(sine/13)),RAD(0+0*math.cos(sine/13)),RAD(0+0*math.cos(sine/13))),.3)
elseif Root.Velocity.Magnitude < 20 then -- walk
NECK.C0 = NECK.C0:Lerp(CF(0+0*math.cos(sine/13),1+0*math.cos(sine/13),0+0*math.cos(sine/13))*ANGLES(RAD(0+0*math.cos(sine/13)),RAD(0+0*math.cos(sine/13)),RAD(0+0*math.cos(sine/13))),.3)
RJ.C0 = RJ.C0:Lerp(CF(0+0*math.cos(sine/2),0+0.3*math.cos(sine/2),0+0*math.cos(sine/2))*ANGLES(RAD(-10+5*math.sin(sine/2))*lookvel,RAD(0+0*math.cos(sine/2)),RAD(-5+5*math.sin(sine/2))*rightvel),.3)
RS.C0 = RS.C0:Lerp(CF(0.5+0*math.cos(sine/4),-1+0.5*math.cos(sine/4),0.8+0*math.cos(sine/4))*ANGLES(RAD(0+20*math.sin(sine/4))*lookvel,RAD(20+0*math.cos(sine/4)),RAD(0+20*math.sin(sine/4))*rightvel),.3)
LS.C0 = LS.C0:Lerp(CF(-0.5+0*math.cos(sine/4),-1+-0.5*math.cos(sine/4),0.8+0*math.cos(sine/4))*ANGLES(RAD(0+-20*math.sin(sine/4))*lookvel,RAD(-20+0*math.cos(sine/4)),RAD(0+-20*math.sin(sine/4))*rightvel),.3)
RH.C0 = RH.C0:Lerp(CF(0.5+0*math.cos(sine/4),-1+-0.5*math.cos(sine/4),-0.8+0*math.cos(sine/4))*ANGLES(RAD(0+-20*math.sin(sine/4))*lookvel,RAD(-20+0*math.cos(sine/4)),RAD(0+-20*math.sin(sine/4))*rightvel),.3)
LH.C0 = LH.C0:Lerp(CF(-0.5+0*math.cos(sine/4),-1+0.5*math.cos(sine/4),-0.8+0*math.cos(sine/4))*ANGLES(RAD(0+20*math.sin(sine/4))*lookvel,RAD(20+0*math.cos(sine/4)),RAD(0+20*math.sin(sine/4))*rightvel),.3)
